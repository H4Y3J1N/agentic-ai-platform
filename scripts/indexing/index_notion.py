...
sys.path.insert(0, str(PROJECT_ROOT / "services" / "internal-ops"))
sys.path.insert(0, str(PROJECT_ROOT / "packages" / "agentic-ai-core" / "src"))
...
class NotionIndexer:
    ...
    def __init__(self, config_dir: str = None):
        self.config_dir = Path(config_dir) if config_dir else (
            PROJECT_ROOT / "services" / "internal-ops" / "config"
        )
    ...
    async def initialize(self):
        ...
        from src.internal_ops_service.integrations.notion import (
            NotionClient,
            NotionClientConfig,
            NotionSyncManager,
            SyncConfig
